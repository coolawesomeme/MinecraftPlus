...
public class PlusItemSword extends Item
{
    private int weaponDamage;
    private final PlusToolMaterial toolMaterial;

    public PlusItemSword(int par1, PlusToolMaterial par2PlusToolMaterial)
    {
        super(par1);
        toolMaterial = par2PlusToolMaterial;
        maxStackSize = 1;
        setMaxDamage(par2PlusToolMaterial.getMaxUses());
        weaponDamage = 4 + par2PlusToolMaterial.getDamageVsEntity();
    }
