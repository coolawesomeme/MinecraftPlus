...
public class BlockPizza extends BlockNormal
{
    protected BlockPizza(int par1, int par2)
    {
    ...
    {
        return par1 == 1 ? 17 : (par1 == 0 ? 18 : (par2 > 0 && par1 == 4 ? 20 : 19));
    }
    ...
    {
        return MinecraftPlusBase.pizzaSlice.shiftedIndex;
    }
}
