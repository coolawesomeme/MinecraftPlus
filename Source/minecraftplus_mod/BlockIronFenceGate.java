...
public class BlockIronFenceGate extends BlockFenceGate
{
    ...
    public BlockIronFenceGate(int par1, int par2)
    {
        super(par1, par2);
    }
    ...
    public boolean removeBlockByPlayer(World world, EntityPlayer entityplayer, int x, int y, int z){
    	if(entityplayer.inventory.currentItem != Item.pickaxeDiamond.shiftedIndex && entityplayer.inventory.currentItem != Item.pickaxeGold.shiftedIndex && entityplayer.inventory.currentItem != Item.pickaxeSteel.shiftedIndex && entityplayer.inventory.currentItem != Item.pickaxeStone.shiftedIndex && entityplayer.inventory.currentItem != MinecraftPlusBase.embroniumPickaxe.shiftedIndex){
    		dropID = 0;
    	}else{
