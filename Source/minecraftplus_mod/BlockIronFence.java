...
{
    public BlockIronFence(int par1, int par2)
    {
        super(par1, par2, Material.iron);
    }

    public BlockIronFence(int par1, int par2, Material par3Material)
    {
    ...
    public boolean canConnectFenceTo(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    {
        ...
        if (var5 != this.blockID && var5 != MinecraftPlusBase.ironFenceGate.blockID)
        {
    ...
    {
        return par0 == Block.fence.blockID || par0 == Block.netherFence.blockID || par0 == MinecraftPlusBase.ironFence.blockID;
    }
