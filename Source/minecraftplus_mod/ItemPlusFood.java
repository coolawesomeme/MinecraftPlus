...
public class ItemPlusFood extends ItemFood
{
    ...
    public ItemPlusFood(int par1, int par2, float par3, boolean par4)
    {
     ...
     */
    public ItemPlusFood setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
     ...
     */
    public ItemPlusFood setAlwaysEdible()
    {
