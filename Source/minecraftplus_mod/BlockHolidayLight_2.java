...
public class BlockHolidayLight_2 extends BlockNormal{

	/** Whether this lamp block is the powered version. */
    private final boolean powered;
	
	public BlockHolidayLight_2(int par1, boolean isPowered) {
		super(par1, 28, Material.circuits);
    ...
    public void onBlockAdded(World par1World, int par2, int par3, int par4)
    {
        if (!par1World.isRemote)
        {
            ...
            else if (!this.powered && par1World.isBlockIndirectlyGettingPowered(par2, par3, par4))
            {
                ...
                par1World.setBlockAndMetadataWithNotify(par2, par3, par4, MinecraftPlusBase.holidaylights_2Active.blockID, m);
            }
        }
    }
    /**
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
        	int m = par1World.getBlockMetadata(par2, par3, par4);
            par1World.setBlockAndMetadataWithNotify(par2, par3, par4, MinecraftPlusBase.holidaylights_2Idle.blockID, m);
        }
    }    
    ...
    {
        return MinecraftPlusBase.holidaylights_2Idle.blockID;
    }
