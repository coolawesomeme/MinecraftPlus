...
public class BlockTrapFireSpread extends Block {
    ...
    {
      int missed = 0;
      int b_1 = MinecraftPlusBase.getRandomInt(1);
      int b_2 = MinecraftPlusBase.getRandomInt(1);
      int b_3 = MinecraftPlusBase.getRandomInt(1);
      int b_4 = MinecraftPlusBase.getRandomInt(1);
      int b_5 = MinecraftPlusBase.getRandomInt(1);
      int b_6 = MinecraftPlusBase.getRandomInt(1);
      int b_7 = MinecraftPlusBase.getRandomInt(1);
      int b_8 = MinecraftPlusBase.getRandomInt(1);
      if(b_1 == 1){
