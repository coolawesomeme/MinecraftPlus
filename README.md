...
The source files up are for **Minecraft+ r2b6**. *(The r is the release number, which changes every time a public release is made (Not including bugfixes). The b is the build number, intended for internal use.)* This will update every time a commit is made to the source files.
...
Note: As of r2b5, fixed the whole server issue. SO HAPPY!